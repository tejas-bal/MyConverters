...
const styles: any = {
  ...
  labelCell: { fontSize: "24px", fontWeight: 500 },
  valueCell: { fontSize: "24px", fontWeight: "bold", textAlign: "right" },
  flag: { width: "40px", height: "25px", objectFit: "cover", borderRadius: "4px" },
  refresh: { fontSize: "16px", color: "#ccc", textAlign: "center", marginTop: "10px" },
};